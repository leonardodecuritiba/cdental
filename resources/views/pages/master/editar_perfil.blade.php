                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-11 col-sm-11 col-xs-6 form-group has-feedback">
                                        <input type="text" class="form-control has-feedback-left" name="nome" id="inputSuccess2" value="Jose">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-6 form-group has-feedback">
                                        <input type="text" class="form-control has-feedback-left" name="e-mail" id="inputSuccess2" value="dr.jose@gmail.com">
                                        <span class="fa fa-envelope-o form-control-feedback left" aria-hidden="true"></span>
                                    </div>
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Senha:
                                    </label>
                                    <div class="col-md-5 col-sm-5 col-xs-6 form-group has-feedback">
                                        <input type="password" class="form-control has-feedback-left" name="password" id="inputSuccess2" value="kkkkkk">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-6 form-group has-feedback">
                                        <input type="text" class="form-control has-feedback-left" name="telefone" id="inputSuccess3" value="(41)3223-9999">
                                        <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
                                    </div>
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Celular:
                                    </label>
                                    <div class="col-md-5 col-sm-5 col-xs-6 form-group has-feedback">
                                        <input type="text" class="form-control has-feedback-left" name="celular" id="inputSuccess2" value="(41)9879-9999">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5 col-sm-5 col-xs-6 form-group has-feedback">
                                            <input type="text" class="form-control has-feedback-left" name="cpf" id="inputSuccess2" value="122.333.245-21">
                                            <span class="fa fa-newspaper-o form-control-feedback left" aria-hidden="true"></span>
                                        </div>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">CRO:
                                        </label>
                                        <div class="col-md-5 col-sm-5 col-xs-6 form-group has-feedback">
                                            <input type="text" class="form-control has-feedback-left" name="cro" id="inputSuccess3" value="51.546.324-5">
                                            <span class="fa fa-newspaper-o form-control-feedback left" aria-hidden="true"></span>
                                        </div>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Foto:
                                        </label>
                                        <div class="col-md-5 col-sm-5 col-xs-6 form-group has-feedback">
                                            <input name="foto" type="file" class="form-control" rows="9" cols="25" required="required" data-parsley-id="0599">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 form-group has-feedback">
                                            <input type="text" class="form-control has-feedback-left" name="endereco" id="inputSuccess2" value="Frederico Maurer">
                                            <span class="fa fa-home form-control-feedback left" aria-hidden="true"></span>
                                        </div>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Bairro.:
                                        </label>
                                        <div class="col-md-3 col-sm-3 col-xs-6 form-group has-feedback">
                                            <input type="text" class="form-control" name="bairro" id="inputSuccess3" value="Hauer">
                                            <span class="fa fa-home form-control-feedback right" aria-hidden="true"></span>
                                        </div>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Complemen.:
                                        </label>
                                        <div class="col-md-3 col-sm-3 col-xs-6 form-group has-feedback">
                                            <input type="text" class="form-control" name="complemento" id="inputSuccess3" value="Casa">
                                            <span class="fa fa-home form-control-feedback right" aria-hidden="true"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 form-group has-feedback">
                                            <input type="text" class="form-control has-feedback-left" name="cidade" id="inputSuccess2" value="Curitiba">
                                            <span class="fa fa-home form-control-feedback left" aria-hidden="true"></span>
                                        </div>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">CEP:
                                        </label>
                                        <div class="col-md-3 col-sm-3 col-xs-6 form-group has-feedback">
                                            <input type="text" class="form-control" id="inputSuccess3" name="cep" value="91.543.222">
                                            <span class="fa fa-newspaper-o form-control-feedback right" aria-hidden="true"></span>
                                        </div>
