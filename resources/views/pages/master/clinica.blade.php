                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(['route' => $route, 'files' => true,
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" name="email" placeholder="clinica@gmail.com"
                            ...
                            <section id="endereco">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                                        <input type="text" class="form-control show-cep" id="cep" name="cep" placeholder="CEP"
                                               value="@if(isset($Clinica->contato->cep)){{$Clinica->contato->cep}}@else{{old('cep')}}@endif" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 form-group input-cidade">
                                        <input type="text" class="form-control input-cidade" name="cidade" maxlength="60" id="inputSuccess2" placeholder="Cidade"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                        <input type="text" class="form-control input-logradouro" name="logradouro" maxlength="100" placeholder="Endereço"
