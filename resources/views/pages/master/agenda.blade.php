                ...
                <div class="x_title">
                    ...
                    <div class="title_right">
                        <div class="pull-right">
                            <button class="btn btn-primary nova-consulta" data-toggle="modal" data-target="#CalenderModalNew"><i class="fa fa-plus"></i> Nova Consulta</button>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
...
//                    console.log(event.title + " was dropped on " + event.start.format('DD/MM/YYYY HH:mm'));
                    ...
                    data_ = {idconsulta: event.data.idconsulta,
