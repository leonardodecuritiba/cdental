<div class="x_title">
    ...
    <ul class="nav navbar-right panel_toolbox">
        <li>
            <button class="btn btn-success" id="refresh-documento"><i class="fa fa-refresh fa-2"></i> Atualizar</button>
        </li>
    </ul>
                ...
                <div class="col-md-55">
                    <div class="thumbnail">
                        <div class="image view view-first">
                            <img style="width: 100%; display: block;" src="{{$documento->getDocumentoThumb()}}" alt="image" />
                            <div class="mask">
