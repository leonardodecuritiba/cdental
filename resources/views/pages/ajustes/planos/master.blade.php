                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="checkbox">
                                    <label class="plano_padrao">
                                        <input type="radio" name="plano_padrao" class="flat" value="0" checked="checked"> Não copiar (plano vazio)
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label class="plano_padrao">
                                        <input type="radio" name="plano_padrao" class="flat" value="1"> Copiar tratamentos do plano
                                    </label>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                                ...
                                                {!! Form::open(['method' => 'PATCH','route'=>['plano_intervencao.update',$plano_intervencao->idplano_intervencao], 'class' => 'form-horizontal form-label-left']) !!}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="show-valor" data-value="{{$plano_intervencao->valor_plano}}">
                                                            ...
                                                            <input name="valor_plano" type="text" class="form-control show-valor hide" value="{{$plano_intervencao->valor_plano}}">
                                                        </td>
                                        ...
                                        <tr id="add" class="hide">
                                            {!! Form::open(['route'=>'plano_intervencao.store', 'class' => 'form-horizontal form-label-left']) !!}
                                                ...
                                                <td id="regiao"></td>
                                                <td id="valor"></td>
                                                <td><input name="valor_plano" type="text" class="form-control show-valor" value=""></td>
                                                ...
                                                <td>
                                                    <button disabled type="submit" class="btn btn-info btn-xs">
                                                        <i class="fa fa-plus fa-sm"></i> Adicionar Intervenção</button>
                                                </td>
                                            {!! Form::close() !!}
                                        </tr>
                                    </tbody>
