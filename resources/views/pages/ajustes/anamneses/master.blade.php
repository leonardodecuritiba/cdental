                                ...
                                <tbody>
                                            ...
                                            {!! Form::open(['method' => 'PATCH','route'=>['perguntas.update',$pergunta->idpergunta], 'class' => 'form-horizontal form-label-left']) !!}
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input name="numero_ordem" type="text" class="form-control hide" value="{{$pergunta->numero_ordem}}">
                                                    </td>
                                                    <td>
                                                        <span>{{$pergunta->texto_pergunta}}</span>
                                                        <input name="texto_pergunta" type="text" class="form-control hide" value="{{$pergunta->texto_pergunta}}">
                                                    </td>
                                                    <td>
                                                        <span>{{$pergunta->traduzTipoPergunta()}}</span>
                                                        <select id="tipo_pergunta" name="tipo_pergunta" class="form-control hide" required>
                                                    ...
                                                    <td>
                                                        ...
                                                        <select id="tipo_resposta" name="tipo_resposta" class="form-control hide" required>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input name="msg_alerta" type="text" class="form-control hide" value="{{$pergunta->msg_alerta}}">
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-default btn-xs" id='open-modal' data-pergunta="{{json_encode($pergunta)}}" data-target="#perguntaModal"><i class="fa fa-eye"></i> Visualizar</a>
                                                        <a class="btn btn-primary btn-xs" id="edit-inline"><i class="fa fa-edit"></i> Editar</a>
                                                        <button type="submit" class="btn btn-success btn-xs hide"><i class="fa fa-check"></i> Salvar</button>
                                    ...
                                    <tr id="add">
                                        {!! Form::open(['route'=>'perguntas.store', 'class' => 'form-horizontal form-label-left']) !!}
                                            <input name="idanamnese" type="hidden" value="{{$Anamnese->idanamnese}}">
                                            <td>
                                                <input type="number" id="numero_ordem" name="numero_ordem" class="form-control" value="{{++$last_numero_ordem}}" required>
                                            </td>
                                            <td><input name="texto_pergunta" type="text" class="form-control" value="" placeholder="Texto da pergunta" required></td>
                                            <td>
                                            ...
                                            <td><input name="msg_alerta" type="text" class="form-control" value="" placeholder="Mensagem de alerta em caso crítico"></td>
                                            <td>
                                                <button type="submit" class="btn btn-info btn-xs">
                                                    <i class="fa fa-plus fa-sm"></i> Adicionar Pergunta</button>
                                            </td>
                                        {!! Form::close() !!}
                                    </tr>
                                </tbody>
...
@section('scripts_content')
    <script>
        ...
        {
            switch($value){
                case 0: $value = 'Não crítica'; break;
                case 1: $value = 'Crítica para SIM'; break;
                case 2: $value = 'Crítica para NÃO'; break;
            }
            return $value;
        }
