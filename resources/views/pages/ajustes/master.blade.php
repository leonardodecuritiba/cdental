...
@section('page_content')
                    ...
                    <form class="form-horizontal form-label-left">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button"  data-toggle="modal" data-target="#exampleModal2" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Incluir </button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>R$500,00</td>
                                <td>
                                    <button type="button"  data-toggle="modal" data-target="#exampleModal1" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Editar </button>
                                        <button type="button" class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Excluir </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>R$500,00</td>
                                <td>
                                    <button type="button"  data-toggle="modal" data-target="#exampleModal2" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Editar </a>
                                        <button type="button" class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Excluir </a>
                                </td>
                            </tr>
                            <tr>
    ...
    <div class="right_col" role="main">
        ...
        <div class="row tile_count" style="padding:10px;">
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalNovo">Novo {{$Page->Target}}</button>
        </div>
        <!-- /top tiles -->
        <div class="row">
            @foreach($Resultado as $resultado)
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <div class="x_panel tile fixed_height_330">
                        ...
                        <button type="button" class="btn btn-round btn-success" data-toggle="modal" data-target="#modalEditar">Editar</button>
                        <button type="button" class="btn btn-round btn-danger" data-toggle="modal" data-target="#modalExcluir">Excluir</button>
                    </div>
                </div>
            @endforeach
        </div>
