    ...
    <div class="x_content">
        <div class="col-md-4 col-md-offset-2 col-sm-4 col-xs-12 ">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 input-group input-group-lg">
                <input id="buscar" name="busca" type="text" class="form-control" value="{{Request::has('busca')?Request::get('busca'):''}}" placeholder="Buscar {{$Page->Target}}...">
        ...
        <div class="col-md-3 col-sm-4 col-xs-12 form-group">
            <a href="{{ route(strtolower($Page->link).'.create') }}" class="btn btn-info btn-lg btn-block">Cadastrar {{$Page->Target}}</a>
        </div>
